...
export default class UICycle extends UIElement {
  constructor({
    parent, text, values, value, hint, id, changeFunc,
  }) {
    super({
      parent, type: 'div', id, className: 'UICycle',
    });
    this.text = text;
    this.value = value;
    this.values = values;
    ...
    this.textElement = new UIElement({
      parent: this.element, type: 'span', id: `${id}-text`, className: 'UICycle-text',
    });
