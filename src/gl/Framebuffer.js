export default class Framebuffer {
  constructor({gl, texture} = {}) {
    ...
    this.gl.framebufferTexture2D(this.gl.DRAW_FRAMEBUFFER, this.gl.COLOR_ATTACHMENT0, this.gl.TEXTURE_2D, texture.id, 0);
  }
  ...
  retrieve() {
    ...
    this.gl.readPixels(0, 0, this.texture.size.width, this.texture.size.height, this.gl.RGBA, this.gl.FLOAT, data);
    return data;
  }
}
